...
def test_request_latency_uses_module_buckets() -> None:
    """The histogram must reuse the module-level ``_BUCKETS`` (card constraint)."""
    ...
    for boundary in metrics_mod._BUCKETS:
